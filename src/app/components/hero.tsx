          ...
          >
            ...
            <div className="mt-12 flex items-center gap-8">
              <div>
                ...
                <div className="text-sm text-gray-500">{t('hero.stats.meals')}</div>
              </div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{t('hero.stats.accuracy')}</div>
              </div>
              <div className="w-px h-12 bg-white/10"></div>
              <div>
                <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-violet-400 bg-clip-text text-transparent">50K+</div>
                <div className="text-sm text-gray-500">{t('hero.stats.users')}</div>
              </div>
            </div>
          </motion.div>
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <div className="text-sm text-gray-400">{t('hero.analysis.title')}</div>
                      </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center p-2 bg-emerald-500/20 backdrop-blur-sm rounded-[12px] border border-emerald-400/30">
                      <div className="text-xs text-emerald-300">{t('hero.analysis.protein')}</div>
                    ...
                    <div className="text-center p-2 bg-amber-500/20 backdrop-blur-sm rounded-[12px] border border-amber-400/30">
                      <div className="text-xs text-amber-300">{t('hero.analysis.carbs')}</div>
                    ...
                    <div className="text-center p-2 bg-purple-500/20 backdrop-blur-sm rounded-[12px] border border-purple-400/30">
                      <div className="text-xs text-purple-300">{t('hero.analysis.fat')}</div>
